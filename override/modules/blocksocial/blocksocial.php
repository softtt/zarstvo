...
class blocksocialOverride extends blocksocial
{
    ...
    public function install()
    {
        return (parent::install() AND Configuration::updateValue('BLOCKSOCIAL_FACEBOOK', '') &&
            ...
            Configuration::updateValue('BLOCKSOCIAL_OK', '') &&
    ...
    public function uninstall()
    {
        ...
        return (Configuration::deleteByName('BLOCKSOCIAL_FACEBOOK') AND
            ...
            Configuration::deleteByName('BLOCKSOCIAL_OK') AND
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitModule'))
        {
            ...
            Configuration::updateValue('BLOCKSOCIAL_OK', Tools::getValue('blocksocial_ok', ''));
    ...
    public function hookDisplayFooter()
    {
        if (!$this->isCached('blocksocial.tpl', $this->getCacheId()))
            $this->smarty->assign(array(
                ...
                'ok_url' => Configuration::get('BLOCKSOCIAL_OK'),
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'label' => $this->l('OK URL:'),
                        'name' => 'blocksocial_ok',
                        'desc' => $this->l('Your official OK account.'),
                    ),
                    array(
                        'type' => 'text',
                        'label' => $this->l('VK URL:'),
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'blocksocial_ok' => Tools::getValue('blocksocial_ok', Configuration::get('BLOCKSOCIAL_OK')),
