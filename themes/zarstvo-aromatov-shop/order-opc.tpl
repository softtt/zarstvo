...
{else}
	{if $productNumber}
		...
		{include file="$tpl_dir./order-opc-quick.tpl"}
...
{addJsDef productNumber=$productNumber}
...
{addJsDef t4axEnabled=$use_taxes}
...
{addJsDefL name=txtErrorsHappened}{l s='Some errors happened. Please retry later.' js=1}{/addJsDefL}
{addJsDefL name=txtThereisNextErrors}{l s='There is next errors' js=1}{/addJsDefL}
{addJsDefL name=txtRequiredFieldsAreNotFilled}{l s='Required fields are not filled' js=1}{/addJsDefL}
{addJsDefL name=txtPaymentMethodNotChoosed}{l s='Please choose payment method' js=1}{/addJsDefL}
{addJsDefL name=txtBonusNotChoosed}{l s='Please choose your discount bonus' js=1}{/addJsDefL}
...
{if isset($point_of_delivery) && $point_of_delivery}
    {addJsDef point_of_delivery_address = $point_of_delivery}
{/if}
{if isset($guestInformations) and $guestInformations}
    {addJsDef informations = $guestInformations}
{else}
    {addJsDef informations = false}
{/if}
