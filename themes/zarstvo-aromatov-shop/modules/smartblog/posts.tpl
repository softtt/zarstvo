{capture name=path}<a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='All Blog News' mod='smartblog'}</a><span class="navigation-pipe">{$navigationPipe}</span>{$post_title}{/capture}
<div id="content" class="cms-page-content rte">
   <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post block-cms">
   		<div class="page-item-title">
   			<h1 class="page-heading">{$post_title}</h1>
   		</div>
