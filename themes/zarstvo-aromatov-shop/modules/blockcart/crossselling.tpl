...
{*
	<div class="crossseling-content">
		<h2>{l s='Customers who bought this product also bought:' mod='blockcart'} gdffg</h2>
...
*}
    ...
    <section class="crossseling-content">
        <h2>
            {l s='Customers who bought this product also bought:' mod='blockcart'}
        </h2>

        {include file="$tpl_dir./product-list.tpl" products=$orderProducts class='tab-pane' id='crosssellings'}
    </section>
{/if}
