...
<div class="clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} header_cart_logo">
{/if}
    <a class="logo" href="/"><img src="{$img_dir}/transparent2.png" alt="Интернет-магазин Царство Ароматов"></a>
    <div class="shopping_cart">
        <a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}#cart" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
            <span class="cart-packet"></span>
            <span class="cart-text">
                <b>{l s='Cart' mod='blockcart'}</b>
                <br>
                <span class="ajax_cart_product_txt{if $cart_qties != 1} unvisible{/if}">{l s='Products' mod='blockcart'}:</span>
...
{if !$PS_CATALOG_MODE && $active_overlay == 1}
    <div id="layer_cart">
        <div class="clearfix">
            ...
            <div class="layer_cart_product col-xs-12 col-md-9">
               <table id="product-information">
                    <tr>
                        <td rowspan="4" id="delete_product">
                            <a rel="nofollow" title="{l s='Delete' mod='blockcart'}" class="cart_quantity_delete layer_cart_quantity_delete">
                               <i class="ion ion-ios-close-outline"></i>
                            </a>
                        </td>
                    </tr>
                   <tr>
                       <td rowspan="3" class="product-image-container layer_cart_img">
                       </td>
                       <td class="layer_cart_product_main_attributes">
                            ...
                            <span class="comments_note">
                                ...
                                <span class="nb-comments"><span></span> {l s='Review(s)' mod='blockcart'}</span>
                            </span>
                       </td>
                   </tr>
                   <tr>
                       <td class="product_price_quantity layer_cart_quantity">
                            <div class="cart_quantity_button clearfix">
                                <a rel="nofollow" class="cart_quantity_down btn btn-default button-minus" id="cart_quantity_down" title="Убрать">
                                    <span><i class="icon-minus"></i></span>
                                </a>

                                <input type="hidden" value="1" name="quantity_hidden">
                                <input size="2" type="text" autocomplete="off" class="layer_cart_quantity_input form-control" value="1" name="quantity">

                                <a rel="nofollow" class="cart_quantity_up btn btn-default button-plus" id="cart_quantity_up" title="Добавить">
                                    <span><i class="icon-plus"></i></span>
                                </a>
                            </div>

                            <div class="layer_cart_cost">
                                <span>{l s='Cost' mod='blockcart'}</span>
                                <span id="layer_cart_product_cost"></span>
                            </div>
                       </td>
                   </tr>
                   <tr>
                       <td class="layer_cart_price">
                            <span>{l s='To the amount of' mod='blockcart'}</span>
            ...
            <div class="layer_cart_cart col-xs-12 col-md-3">
                <!-- <h2>
                    {l s='Your cart' mod='blockcart'}
                </h2> -->
                <div class="cart_data_container">
                    <div class="row_block row_block_top col-xs-6 col-md-12">
                        ...
                        <div class="layer_cart_row discount">
                            <span class="ajax_discount_name">
                                {l s='Discount:'}
                            </span>
                            <span class="ajax_discount_sum"></span>
                        </div>

                        <div class="layer_cart_row">
                            <span class="">
                                {l s='To the amount of' mod='blockcart'}
                            </span>
                    ...
                    <div class="row_block button-container col-xs-6 col-md-12">
        ...
        <div class="crossseling crosselling_layer_block"></div>
    </div> <!-- #layer_cart -->
