...
<div id="layered_block_left" class="block">
    <p class="title_block">{l s='Filters' mod='blocklayered'}</p>
                ...
                {foreach from=$filters item=filter}
                    {if isset($filter.values)}
                        ...
                        <div class="layered_subtitle_heading">
                            <span class="layered_subtitle" data-rel="ul_layered_{$filter.type}_{$filter.id_key}">{$filter.name|escape:'html':'UTF-8'}</span>
                        </div>
    ...
    <div id="layered_ajax_loader" style="display: none;">
        <p class="layered_ajax_loader_spinner">
