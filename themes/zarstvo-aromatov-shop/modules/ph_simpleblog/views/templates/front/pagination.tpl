...
{if $start!=$stop}
	...
	{if $p != 1}
		...
		<li id="pagination_previous" class="pagination_previous"><a href="{SimpleBlogPost::getPageLink($p_previous, $type, $rewrite)|escape:'html':'UTF-8'}" rel="prev">{l s='Назад' mod='ph_simpleblog'}</a></li>
	{else}
	...
	{if $pages_nb > 1 AND $p != $pages_nb}
		...
		<li id="pagination_next" class="pagination_next"><a href="{SimpleBlogPost::getPageLink($p_next, $type, $rewrite)|escape:'html':'UTF-8'}" rel="next">{l s='Вперед' mod='ph_simpleblog'}</a></li>
	{else}
