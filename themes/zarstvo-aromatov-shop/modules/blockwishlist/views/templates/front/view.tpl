...
<div id="view_wishlist">
    ...
    {/if}
    {*{include file="$tpl_dir./product-list.tpl" products=$products class='blockspecials tab-pane' id='blockspecials' }*}
