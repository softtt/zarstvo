...
<section id="social_block" class="col-xs-12 col-sm-6">
    <ul>
        ...
        {if isset($ok_url) && $ok_url != ''}
            <li class="ok">
                <a class="_blank" href="{$ok_url|escape:html:'UTF-8'}">
                    <span>{l s='Odnoklassniki' mod='blocksocial'}</span>
                </a>
            </li>
        {/if}
...
<!-- <a class="dev-link" href="http://smart-raccoon.com/" target="_blank">Разработка сайта - <strong>Smart Raccoon</strong></a> -->
