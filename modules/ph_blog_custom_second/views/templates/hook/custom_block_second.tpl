{if isset($custom_block_second_posts) && count($custom_block_second_posts)}
...
<section class="ph_simpleblog simpleblog-recent block" id="blog_custom_block">
	<p class="title_block">
		<a href="{$link->getModuleLink('ph_simpleblog', 'list')}" title="{l s='Recent posts' mod='ph_blog_custom_second'}">{$title}</a>
	</p>
	<div class="row simpleblog-posts" itemscope="itemscope" itemtype="http://schema.org/Blog">
			{foreach from=$custom_block_second_posts item=post}
					...
					<div class="post-item">
						...
						{else}
							...
							<div class="post-thumbnail" itemscope itemtype="http://schema.org/ImageObject">
								<a href="{$post.url|escape:'html':'UTF-8'}" title="{l s='Permalink to' mod='ph_blog_custom_second'} {$post.title|escape:'html':'UTF-8'}" itemprop="contentUrl">
						...
						{else}
							<div class="post-title">
								<h2 itemprop="headline">
									<a href="{$post.url|escape:'html':'UTF-8'}" title="{l s='Permalink to' mod='ph_blog_custom_second'} {$post.title|escape:'html':'UTF-8'}">
						...
						{else}
							...
							<div class="post-content" itemprop="text">
								...
								<div class="post-read-more">
									<a href="{$post.url|escape:'html':'UTF-8'}" title="{l s='Read more' mod='ph_blog_custom_second'}">
										{l s='Read more' mod='ph_blog_custom_second'} <i class="fa fa-chevron-right"></i>
									</a>
								</div><!-- .post-read-more -->
								{/if}
							</div><!-- .post-content -->	
...
</section><!-- .ph_simpleblog.ph_blog_custom_second -->
{/if}