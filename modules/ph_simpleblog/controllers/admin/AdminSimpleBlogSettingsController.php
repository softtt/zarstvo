    ...
    public function initOptions()
    {
        ...
        $standard_options = array(
            ...
            'comments_spam_protection' => array(
                'submit' => array('title' => $this->l('Update'), 'class' => 'button'),
                'title' =>  $this->l('Comments - Spam Protection'),
            ...
            'troubleshooting' => array(
                ...
                'fields' => array(
                     ...
                     'PH_BLOG_RELATED_PRODUCTS_USE_DEFAULT_LIST' => array(
                        ...
                        'cast' => 'intval',
                        'required' => true,
                        'desc' => $this->l('By default Blog for PrestaShop uses default-bootstrap product list markup for related products, you can switch this option to load your product-list.tpl instead.'),
                        'type' => 'bool'
