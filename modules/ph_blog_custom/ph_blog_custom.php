...
class PH_Blog_Custom extends Module
{
    ...
    public static $cfg_prefix = 'PH_BLOG_CUSTOM_';
    
    public function __construct()
    {
        $this->name = 'ph_blog_custom';
        ...
        $this->displayName = $this->l('Blog for PrestaShop - custom block on homepage');
    }

    public function getDefaults()
    {
        return array(
            'TITLE' => $this->prepareValueForLangs('Title of the custom block'),
            'FROM' => 'recent',
            'NB_POSTS' => 2,
        );
    }
    ...
    {
        $posts = $this->preparePosts(Configuration::get('PH_BLOG_CUSTOM_NB_POSTS'), Configuration::get('PH_BLOG_CUSTOM_FROM'));
    ...
    public function hookDisplayHome($params)
    {
        ...
        return $this->display(__FILE__, 'custom_block.tpl');
    }
}
