...
{if $status == 'ok'}
	<p>
		...
		<br /><br />{l s='Total sum to pay:' mod='prepayment'} <span class="price"><strong>{$total_to_pay}</strong></span>
		{if !isset($reference)}
		...
		<br /><br /> <strong>{l s='Your order will be sent as soon as we receive payment.' mod='prepayment'}</strong>
