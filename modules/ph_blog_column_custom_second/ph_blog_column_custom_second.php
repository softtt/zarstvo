...
class PH_Blog_Column_Custom_Second extends Module
{
    ...
    public static $cfg_prefix = 'PH_BLOG_COLUMN_CUSTOM_SECOND';
    
    public function __construct()
    {
        $this->name = 'ph_blog_column_custom_second';
        ...
        $this->displayName = $this->l('Blog for PrestaShop - second custom block in the column');
    }
    ...
    public function prepareBlogColumnView()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'second_custom_block_column_posts' => $posts,
    ...
    public function hookDisplayLeftColumn($params)
    {
        ...
        return $this->display(__FILE__, 'second_custom_block_column.tpl');
    }
    ...
    public function hookDisplayFooter($params)
    {
        ...
        return $this->display(__FILE__, 'second_custom_block_column-footer.tpl');
    }
}
