...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="show_new" type="radio" onclick=""}</span></div>
		<label class="control-label col-lg-2">
			{l s='Show in new block'}
		</label>
		<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
				<input onclick="toggleDraftWarning(false);" type="radio" name="show_new" id="show_new_on" value="1" {if $product->show_new || !$product->isAssociatedToShop()}checked="checked" {/if} />
				<label for="show_new_on" class="radioCheck">
					{l s='Yes'}
				</label>
				<input onclick="toggleDraftWarning(true);"  type="radio" name="show_new" id="show_new_off" value="0" {if !$product->show_new && $product->isAssociatedToShop()}checked="checked"{/if} />
				<label for="show_new_off" class="radioCheck">
					{l s='No'}
				</label>
				<a class="slide-button btn"></a>
			</span>
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="show_bestsales" type="radio" onclick=""}</span></div>
		<label class="control-label col-lg-2">
			{l s='Show in bestsales block'}
		</label>
		<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
				<input onclick="toggleDraftWarning(false);" type="radio" name="show_bestsales" id="show_bestsales_on" value="1" {if $product->show_bestsales || !$product->isAssociatedToShop()}checked="checked" {/if} />
				<label for="show_bestsales_on" class="radioCheck">
					{l s='Yes'}
				</label>
				<input onclick="toggleDraftWarning(true);"  type="radio" name="show_bestsales" id="show_bestsales_off" value="0" {if !$product->show_bestsales && $product->isAssociatedToShop()}checked="checked"{/if} />
				<label for="show_bestsales_off" class="radioCheck">
					{l s='No'}
				</label>
				<a class="slide-button btn"></a>
			</span>
    ...
    <div class="form-group">
        <div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="is_product_of_the_day" type="radio" onclick=""}</span></div>
        <label class="control-label col-lg-2">
            {l s='Показывать в блоке "Продукт дня"'}
        </label>
        <div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
				<input onclick="toggleDraftWarning(false);" type="radio" name="is_product_of_the_day" id="is_product_of_the_day_on" value="1" {if $product->is_product_of_the_day || !$product->isAssociatedToShop()}checked="checked" {/if} />
				<label for="is_product_of_the_day_on" class="radioCheck">
                    {l s='Yes'}
                </label>
				<input onclick="toggleDraftWarning(true);"  type="radio" name="is_product_of_the_day" id="is_product_of_the_day_off" value="0" {if !$product->is_product_of_the_day && $product->isAssociatedToShop()}checked="checked"{/if} />
				<label for="is_product_of_the_day_off" class="radioCheck">
                    {l s='No'}
                </label>
				<a class="slide-button btn"></a>
			</span>
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="recipes" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="recipes_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Appears in the body of the product page.'}">
				{l s='Recipes'}
			</span>
		...
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='recipes'
				class="autoload_rte"
				input_value=$product->recipes}
		</div>
	</div>
