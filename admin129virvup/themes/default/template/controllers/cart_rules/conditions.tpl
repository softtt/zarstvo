...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
		title="{l s='Is this cart rule use for discount cards'}">
			{l s='Discount card cart rule'}
		</span>
	</label>
	<div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
			<input type="radio" name="is_discount_cart_rule" id="is_discount_cart_rule_on" value="1" {if $currentTab->getFieldValue($currentObject, 'is_discount_cart_rule')|intval}checked="checked"{/if}/>
			<label for="is_discount_cart_rule_on">{l s='Yes'}</label>
			<input type="radio" name="is_discount_cart_rule" id="is_discount_cart_rule_off" value="0"  {if !$currentTab->getFieldValue($currentObject, 'is_discount_cart_rule')|intval}checked="checked"{/if} />
			<label for="is_discount_cart_rule_off">{l s='No'}</label>
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Minimum accummulated sum for customer to get this cart rule. Applies only for Discount card cart rules'}">
			{l s='Minimum accumulated amount'}
		</span>
	</label>
	<div class="col-lg-9">
		<div class="col-lg-3">
			<input type="text" name="accumulated_minimum_amount" value="{$currentTab->getFieldValue($currentObject, 'accumulated_minimum_amount')|floatval}" />
		</div>
	</div>
</div>
